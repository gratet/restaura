...
title: "Tesis doctorales vinculadas al proyecto"
...
___"Landscape, Risk, and Health Perceptions in Petrochemical Industrial Clusters: A PPGIS Approach in Tehran and Camp de Tarragona".___

~~~
Directores: Dra. Yolanda Pérez Albert, Dr. David Serrano Giné
Estado: defendida (diciembre de 2025)
~~~   

*Petrochemical clusters and oil refineries are crucial for economic development but pose important environmental and public health challenges. Such industrial activities may have a negative impact on the surrounding communities, change the quality of the landscape, increase exposure to technological risks, and have an impact on the mental health and well-being of residents. Understanding how local populations perceive these risks and the environment around them is crucial to the planning of sustainable urban interventions. The main objective of this thesis is to analyze how residents in petrochemical zones and oil refineries perceive technological risks, landscape quality, and health impacts. 
This thesis uses the Public Participation Geographic Information System (PPGIS) to collect and analyze the perception of the population. In this thesis, the PPGIS survey covers issues related to risk perception, landscape, and health, as well as socio-demographic information.
This thesis examines the complex relationship between technological risk perception, landscape perception, and mental health in two case studies: the Tehran Oil Refinery, Iran, and the Petrochemical Clusters in the Camp de Tarragona, Spain. The research provides critical insights into how environmental, social, and emotional factors influence public perceptions through a comparative, mixed-method approach using geospatial, visual, and psychological data.
Risk perception emerged as a spatially and socially based phenomenon in both case studies, shaped by proximity to industrial infrastructure and gender. The landscape perception component provided convincing evidence of the impact of visual exposure to industrial elements on the subjective state of well-being. In both cases, manipulated photographs reduced the industrial appearance and increased the natural features, significantly reducing anxiety, tension, and restlessness, as well as increasing calm and relaxation. Regarding health perception, both case studies reported a medium stress level as the most common. This thesis emphasizes that, although statistical analysis has shown correlations between perception of landscape and risk and stress, the strength of these relationships varies depending on the context. In Tarragona, more consistent associations were found, suggesting that improvements in visual landscape performance may have more pronounced perceptual and emotional effects in more environmentally literate societies. In Tehran, the weaker correlation highlights the influence of other cultural, social, and institutional factors that shape how people perceive their surroundings and risks. 
This thesis shows that perceptions of technological risk and environmental quality are not just a reflection of physical exposure; they are deeply connected to social identity, information flows, spatial contexts, and emotional states. The comparison between Tehran Oil Refinery and Petrochemical Clusters in Camp de Tarragona shows common patterns and critical differences and highlights the need for culturally sensitive, locally based policies in industrial urban areas.
Finally, the findings provide practical insights for urban planners and policy makers in designing interventions to reduce the environmental and health impact of industrial sites. This thesis supports the development of a healthier urban environment, improves the welfare of communities, and promotes the sustainable coexistence of industry and residential life by integrating PPGIS into participative planning processes*.   
...
~~~
Directores: Dra. Yolanda Pérez Albert, Dr. Joan Alberich González
Estado: defendida (marzo de 2026)
~~~   
